...
import edu.mum.sonet.security.UserPrincipal;
import edu.mum.sonet.security.oauth2.user.OAuth2UserInfo;
import edu.mum.sonet.security.oauth2.user.OAuth2UserInfoFactory;
